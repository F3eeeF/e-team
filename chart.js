...
var chart = new ApexCharts(test, options);
...
var optionsColumn = {
  ...
  series: [
    {
      ...
      data: generateMinuteWiseTimeSeries(
        (new Date("12/12/2016 00:40:00").getTime()), 5)
    }
  ],
  title: {
    text: "Load Average",
  ...
  xaxis: {
    ...
    //range dopo qunato svanisce il chart
    //range: 2700000,
...
var optionsLine = {
  ...
  series: [
    ...
    },
    {
      name: "Waiting",
      data: generateMinuteWiseTimeSeries(
        new Date("12/12/2022 10:20:00").getTime(),
        12,
        {
          min: 30,
          max: 110
